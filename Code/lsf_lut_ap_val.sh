...
WRK_DIR=/work/scratch/malapradej/DASF/Data/LUT_ap/lhd300_valid_ap2
...
do
    ...
    jbnm=${line// /_}
    bsub -q lotus -We 3 -eo "$WRK_DIR/log/err/$jbnm.err" -oo "$WRK_DIR/log/out/$jbnm.out" -J $jbnm "$COD_DIR/env_job_lut_ap_val.sh $line"
done <$1
